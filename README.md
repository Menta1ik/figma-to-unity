# 🌌 Antigravity Figma Importer v2.7.7
...
3. Вставьте ссылку:
   `https://github.com/Menta1ik/figma-to-unity.git?path=/plugin#v2.7.7`
...
## 🛠 Ключевые особенности v2.7.7 (Stability Update)
...
### Новое в v2.7.7 — Prefab Stability

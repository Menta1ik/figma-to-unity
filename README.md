# 🌌 Antigravity Figma Importer v2.7.9
...
3. Вставьте ссылку:
   `https://github.com/Menta1ik/figma-to-unity.git?path=/plugin#v2.7.9`
...
## 🛠 Ключевые особенности v2.7.9 (Stability Update)

### Новое в v2.7.9 — UI Stability & UPM Fix
...
### Новое в v2.7.9 — Prefab Stability

# 🗺️ Roadmap: Разработка Figma Direct Importer v2.2
...
*   [ ] **Auto Layout Support**: Поддержка Figma Vertical/Horizontal Layout через Unity `VerticalLayoutGroup` и `HorizontalLayoutGroup`.
...
## 🎉 СТАТУС РЕЛИЗА
**Версия 2.2.0 (Stable)** — Релиз выпущен `18.04.2026`. Инструмент оптимизирован для работы с очень большими файлами Figma (пакетная загрузка) и стабильного обновления существующих префабов.

---
*Документ утвержден. Релиз 2.2.0 — ВЫПУЩЕН.*

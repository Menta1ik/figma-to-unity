# 🗺️ Roadmap: Разработка Figma Direct Importer v2.3.0 (Hardening)
...
## 🎉 СТАТУС РЕЛИЗА
**Версия 2.3.0 (Hardening)** — Релиз выпущен `19.04.2026`. Инструмент включает в себя Auto Layout, 9-Slice, Soft-Delete и параллельную синхронизацию.

---
*Документ утвержден. Релиз 2.3.0 — ВЫПУЩЕН.*

...
namespace FigmaImporter.V2.Core.Services
{
    public class PrefabManager
    {
        ...
        public void UpdateOrCreatePrefab(GameObject go, string customName = null) 
        {
            ...
            if (success) FigmaLog.Info($"<color=green>[Figma v2.5.0] Prefab saved and connected: {prefabPath}</color>");
            else FigmaLog.Error($"[Figma v2.5.0] Failed to save prefab at {prefabPath}");
        }
    }
}
